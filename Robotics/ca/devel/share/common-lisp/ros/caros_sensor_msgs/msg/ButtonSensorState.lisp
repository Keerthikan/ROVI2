...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ButtonSensorState>)))
  ...
  "5329f8be284c139cf197e749263b35a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ButtonSensorState)))
  "Returns md5sum for a message object of type 'ButtonSensorState"
  "5329f8be284c139cf197e749263b35a9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ButtonSensorState>)))
  ...
  (cl:format cl:nil "# Represents the state of a set of analog and digital buttons.~%~%# Header containing information about time and frameid~%Header header~%~%# Array of bools for digital buttons~%bool[] digital~%~%# IDs for the digital buttons~%string[] digital_ids~%~%# Array of values for analog buttons~%float32[] analog~%~%# IDs for the analog buttons~%string[] analog_ids~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ButtonSensorState)))
  "Returns full string definition for message of type 'ButtonSensorState"
  (cl:format cl:nil "# Represents the state of a set of analog and digital buttons.~%~%# Header containing information about time and frameid~%Header header~%~%# Array of bools for digital buttons~%bool[] digital~%~%# IDs for the digital buttons~%string[] digital_ids~%~%# Array of values for analog buttons~%float32[] analog~%~%# IDs for the analog buttons~%string[] analog_ids~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ButtonSensorState>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'analog) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))

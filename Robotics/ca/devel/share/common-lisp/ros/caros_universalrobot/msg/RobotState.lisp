...
(cl:defmethod cl:initialize-instance :after ((m <RobotState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name caros_universalrobot-msg:<RobotState> is deprecated: use caros_universalrobot-msg:RobotState instead.")))
...
(cl:defmethod is_colliding-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader caros_universalrobot-msg:is_colliding-val is deprecated.  Use caros_universalrobot-msg:is_colliding instead.")
  (is_colliding m))

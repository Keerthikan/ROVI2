...
"""autogenerated by genpy from caros_universalrobot/GripperState.msg. Do not edit."""
import sys
...
class GripperState(genpy.Message):
  ...
  _type = "caros_universalrobot/GripperState"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4B.pack(_x.is_moving, _x.is_blocked, _x.is_stopped, _x.e_stopped))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_moving, _x.is_blocked, _x.is_stopped, _x.e_stopped,) = _struct_4B.unpack(str[start:end])

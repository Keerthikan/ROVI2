// Generated by gencpp from file caros_universalrobot/GripperState.msg
// DO NOT EDIT!


#ifndef CAROS_UNIVERSALROBOT_MESSAGE_GRIPPERSTATE_H
#define CAROS_UNIVERSALROBOT_MESSAGE_GRIPPERSTATE_H
...
struct GripperState_
{
  ...
  typedef boost::shared_ptr< ::caros_universalrobot::GripperState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::caros_universalrobot::GripperState_<ContainerAllocator> const> ConstPtr;

}; // struct GripperState_

typedef ::caros_universalrobot::GripperState_<std::allocator<void> > GripperState;

typedef boost::shared_ptr< ::caros_universalrobot::GripperState > GripperStatePtr;
typedef boost::shared_ptr< ::caros_universalrobot::GripperState const> GripperStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::caros_universalrobot::GripperState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::caros_universalrobot::GripperState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::caros_universalrobot::GripperState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::caros_universalrobot::GripperState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::caros_universalrobot::GripperState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::caros_universalrobot::GripperState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::caros_universalrobot::GripperState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::caros_universalrobot::GripperState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::caros_universalrobot::GripperState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::caros_universalrobot::GripperState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x25dfabc8c04bee11ULL;
  static const uint64_t static_value2 = 0x86049dd520841711ULL;
};

template<class ContainerAllocator>
struct DataType< ::caros_universalrobot::GripperState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "caros_universalrobot/GripperState";
  }
...
template<class ContainerAllocator>
struct Definition< ::caros_universalrobot::GripperState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::caros_universalrobot::GripperState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::caros_universalrobot::GripperState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::caros_universalrobot::GripperState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CAROS_UNIVERSALROBOT_MESSAGE_GRIPPERSTATE_H

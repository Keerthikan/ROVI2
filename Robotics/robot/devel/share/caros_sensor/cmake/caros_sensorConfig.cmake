...
if("TRUE" STREQUAL "TRUE")
  set(caros_sensor_SOURCE_PREFIX /home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Robotics/robot/src/caros/interfaces/caros_sensor)
  set(caros_sensor_DEVEL_PREFIX /home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Robotics/robot/devel)
  ...
  set(caros_sensor_INSTALL_PREFIX /home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Robotics/robot/install)
...
if(NOT "/home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Robotics/robot/src/caros/interfaces/caros_sensor/include " STREQUAL " ")
  set(caros_sensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Robotics/robot/src/caros/interfaces/caros_sensor/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'caros_sensor' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'mband <mband@mmmi.sdu.dk>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'caros_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Robotics/robot/src/caros/interfaces/caros_sensor/${idir}'.  Ask the maintainer 'mband <mband@mmmi.sdu.dk>' to fix it.")
    endif()
    _list_append_unique(caros_sensor_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "caros_sensor")
...
set(depends "caros_common;caros_common_msgs;caros_common_robwork;caros_sensor_msgs;geometry_msgs;message_runtime;std_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${caros_sensor_dep}_FOUND)
      find_package(${caros_sensor_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${caros_sensor_dep} REQUIRED ${depend_list})
  endif()

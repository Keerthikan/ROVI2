...
struct ButtonSensorState_
{
  ...
  _digital_ids_type digital_ids;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _analog_type;
  _analog_type analog;
...
struct MD5Sum< ::caros_sensor_msgs::ButtonSensorState_<ContainerAllocator> >
{
  ...
  {
    return "5329f8be284c139cf197e749263b35a9";
  }

  static const char* value(const ::caros_sensor_msgs::ButtonSensorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5329f8be284c139cULL;
  static const uint64_t static_value2 = 0xf197e749263b35a9ULL;
};

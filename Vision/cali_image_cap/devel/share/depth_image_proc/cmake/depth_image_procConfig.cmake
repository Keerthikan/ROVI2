...
if("TRUE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Vision/cali_image_cap/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Vision/cali_image_cap/devel)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Vision/cali_image_cap/install)
...
if(NOT "/home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Vision/cali_image_cap/src/image_pipeline/depth_image_proc/include " STREQUAL " ")
  set(depth_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Vision/cali_image_cap/src/image_pipeline/depth_image_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/keerthikan/Dropbox/Eksamen/ROVI2/Project/Vision/cali_image_cap/src/image_pipeline/depth_image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
